...
const ScottAppsCTA: React.FC<ScottAppsCTAProps> = ({
  ...
  subline = 'AquaBlast provides flat-rate house washing, roof cleaning, driveways, gutters, and commercial pressure washing across Central Texas — free re-clean if you\'re not happy.',
  variant = 'full',
}) => {
  return (
        ...
        <div className={styles.textSide}>
          ...
          >
            <div className={styles.eyebrow}>
              ...
              <span>AquaBlast Pressure Washing</span>
            </div>
