...
export default function CTABanner({
  ...
  subline = "Same-day soft wash & pressure cleaning across Central Texas. Free re-clean guarantee.",
  ...
  spot = "CTABanner",
  imageSrc,
  eyebrow = "Central Texas Pressure Washing Since 2015",
  badgeA = "Free Re-Clean",
  badgeB = "Licensed & Bonded",
  badgeC = "Flat-Rate",
}: CTABannerProps) {
    ...
    <section className={styles.banner} aria-label="Call to action">
      ...
      >
        ...
        <svg width="420" height="420" viewBox="0 0 24 24" fill="currentColor">
          <path d="M12 2s-5 6.5-5 10a5 5 0 0 0 10 0c0-3.5-5-10-5-10z" />
          <circle cx="6" cy="8" r="1.2" opacity="0.7" />
          <circle cx="18" cy="10" r="1" opacity="0.55" />
          <circle cx="8" cy="5" r="0.8" opacity="0.5" />
        </svg>
      </motion.div>
