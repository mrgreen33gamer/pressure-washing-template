...
export default function NearbyAreasHero({
  ...
  const displayHeadline = headline ?? `Pressure Washing in ${cityName}, TX`;
  const displayDesc     = description ??
    `AquaBlast Pressure Washing provides fast, reliable exterior cleaning to ${cityName} and all surrounding communities. Licensed & bonded crews, flat-rate pricing, free re-clean if you're not happy.`;
    ...
    <section className={styles.section}>
      ...
      <div className={styles.container}>
        ...
        >
          ...
          <a href="tel:+12549008842" className={styles.phoneBtn}>
            <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round">
