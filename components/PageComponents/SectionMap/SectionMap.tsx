  ...
  const initMap = () => {
    ...
    currentMap.on('load', () => {
      ...
      new mapboxgl.Marker({ element: hqEl, anchor: 'center' })
        ...
        .setPopup(new mapboxgl.Popup().setHTML('<strong>AquaBlast Pressure Washing</strong><br>1187 Lake Shore Dr, Waco, TX 76708'))
        .addTo(currentMap);
  ...
  return (
    <section ref={sectionRef} className={styles.mapSection}>
      ...
      <div className={styles.mapLegend}>
        <div><span className={styles.hqDot} /> AquaBlast HQ – Waco</div>
        <div><span className={styles.clientDot} /> Cities &amp; Jobs Serviced</div>
      </div>
