...
const BlogPreviewGrid: React.FC<BlogPreviewGridProps> = ({
  title       = 'Pressure Washing Tips & Insights',
  subtitle    = 'Practical advice for Central Texas homeowners — soft washing vs pressure washing, how often to clean, and how to protect your exterior surfaces.',
  posts,
  count       = 4,
  viewAllLink = '/blogs',
        ...
        <div className={styles.layout}>
          ...
          <div className={styles.listWrap}>
            ...
            <Link href={viewAllLink} className={styles.allBtn}>
              Browse All Pressure Washing Articles
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round">
                <polyline points="9 18 15 12 9 6"/>
              </svg>
            </Link>
