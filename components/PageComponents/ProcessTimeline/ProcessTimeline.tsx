      ...
      <div className={styles.container}>
        ...
        >
          ...
          <h2 className={styles.title}>
            Cleaned in <span className={styles.accent}>4 Simple Steps</span>
          </h2>
          <p className={styles.sub}>
            No runaround. No hidden charges. Just fast, professional exterior cleaning from estimate to final walkthrough.
          </p>
        </motion.div>
