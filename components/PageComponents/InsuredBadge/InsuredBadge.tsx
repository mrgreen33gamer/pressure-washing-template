...
const COVERAGES = [
  ...
  {
    icon: faBuilding,
    title: 'Bonded for Every Job',
    detail: 'Bonded coverage on residential and commercial work',
  },
  {
    icon: faBriefcase,
    title: 'Licensed Technicians',
    detail: 'Trained crews — no uninsured subcontractors',
  },
  {
    icon: faFileContract,
    title: 'Free Re-Clean Guarantee',
    detail: '100% satisfaction — we return at no charge if needed',
  },
];
    ...
    return (
      <div className={styles.inlineBadge}>
        ...
        <span className={styles.inlineText}>
          Licensed, Bonded &amp; Insured — $1M Liability Coverage
        </span>
      </div>
    );
  }
      ...
      <div className={styles.container}>
        ...
        >
          ...
          <div className={styles.headerText}>
            ...
            <h2 className={styles.title}>Licensed, Bonded &amp; Insured</h2>
            <p className={styles.subtitle}>
              Every AquaBlast job is backed by full liability coverage, bonding, and a free re-clean
              guarantee. You get peace of mind — and we get to work with integrity.
            </p>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className={styles.policyInfo}>
            ...
            <span className={styles.policyNum}>Licensed · Bonded · Insured</span>
          </div>
          <Link
            href={ctaLink}
            ...
            onClick={() => trackEvent({
              eventType:    'click',
              elementLabel: 'Get a Free Estimate',
