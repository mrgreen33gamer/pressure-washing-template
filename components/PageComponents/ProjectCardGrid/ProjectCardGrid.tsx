...
const SERVICE_CTAS = [
  {
    ...
    headline: 'Ready for a soft-washed exterior?',
    body: 'Low-pressure soft wash that lifts mildew without damaging siding. Flat-rate pricing, free re-clean guarantee.',
  ...
  },
  {
    ...
    headline: 'Black algae streaks on your roof?',
    body: 'Shingle-safe soft wash that kills algae at the root — no high-pressure granule loss.',
    cta: 'Schedule Roof Cleaning',
  ...
  },
  {
    key: 'driveway',
    icon: faCodeBranch,
    eyebrow: 'Driveway & Concrete',
    headline: 'Oil stains and tire marks?',
    body: 'High-pressure cleaning for driveways, sidewalks, and patios. Flat-rate quotes before we start.',
    cta: 'Clean My Driveway',
  ...
  },
  {
    ...
    body: 'Storefronts, HOAs, restaurants, and parking lots — COIs available, off-hours friendly.',
 ...
 * → "Hot Rocks Logo Design — AquaBlast Portfolio"
 */
function fileToAlt(filename: string): string {
  ...
  return `${words} — AquaBlast Pressure Washing Portfolio`;
}
...
const ProjectCardGrid: React.FC<ProjectCardGridProps> = ({
  title    = 'Our Work',
  subtitle = 'A selection of exterior cleaning jobs for Central Texas homes and businesses',
}) => {
