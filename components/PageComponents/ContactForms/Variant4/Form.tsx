...
import {
  ...
  faHouseChimney, faSprayCanSparkles, faRoad, faDroplet, faTree, faWarehouse, faBroom,
...
const SERVICES = [
  { icon: faHouseChimney,     label: 'House Washing',      sub: 'Siding, soft wash, full exterior' },
  { icon: faSprayCanSparkles, label: 'Roof Cleaning',      sub: 'Algae, moss, black streaks' },
  { icon: faRoad,             label: 'Driveway & Concrete', sub: 'Oil stains, mold, dirt buildup' },
  { icon: faDroplet,          label: 'Gutter Cleaning',     sub: 'Clogs, overflow, debris removal' },
  { icon: faTree,             label: 'Deck & Fence',        sub: 'Wood, composite, vinyl cleanup' },
  { icon: faWarehouse,        label: 'Commercial',          sub: 'Storefronts, lots, facilities' },
  { icon: faBroom,            label: 'Other',               sub: 'Multi-surface or custom jobs' },
];

const BUDGET_LABELS = ['Under $200', '$200–$500', '$500–$1,000', '$1,000–$2,500', '$2,500+'];
              ...
              {submitted ? (
                <motion.div key="success" className={styles.successState}
                  ...
                  <p className={styles.successText}>
                    An AquaBlast crew lead will reach out about your <strong>{selectedService}</strong> service.
                  </p>
