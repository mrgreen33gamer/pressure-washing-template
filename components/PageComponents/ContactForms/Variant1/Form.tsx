            ...
            {submitted ? (
              <motion.div key="success" className={styles.successState}
                ...
                <p className={styles.successText}>
                  A licensed AquaBlast technician will reach out shortly. Keep an eye on your inbox and phone.
                </p>
                ...
                <form className={styles.form} onSubmit={handleSubmit} noValidate>
                  ...
                  <div className={styles.submitRow}>
                    ...
                    <div className={styles.altContact}>
                      ...
                      <span>Need help now?{' '}
                        <a href="tel:+12549008842"
                          onClick={() => trackEvent({ eventType: 'phone_click', elementLabel: 'Call (254) 900-8842', section: 'ContactForm-V1' })}>
                          Call (254) 900-8842
                        </a>
                      </span>
                    </div>
