...
const SERVICES = [
  { icon: faHouseChimney,      label: 'House Washing' },
  { icon: faSprayCanSparkles,  label: 'Roof Cleaning' },
  { icon: faRoad,              label: 'Driveway & Concrete' },
  { icon: faDroplet,           label: 'Gutter Cleaning' },
  { icon: faTree,              label: 'Deck & Fence' },
  { icon: faWarehouse,         label: 'Commercial' },
  { icon: faBroom,             label: 'Other' },
];
        ...
        <div className={styles.card}>
          ...
          <div className={styles.leftPanel}>
            <div className={styles.panelInner}>
              ...
              <span className={styles.quoteAttrib}>— AquaBlast Pressure Washing, Waco TX</span>

              <div className={styles.panelStats}>
                {[
                  { val: '2,400+', lbl: 'Properties Cleaned' },
                  { val: '4.9★',   lbl: 'Google Rating' },
                  { val: '10+',    lbl: 'Years Local' },
                ].map(s => (
              ...
              <div className={styles.panelBadges}>
                {['Same-Day Available', 'Satisfaction Guarantee', 'No Contracts', 'Licensed & Bonded'].map(b => (
              ...
              {submitted ? (
                ...
                <motion.div key="form" initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}>
                  ...
                  <form className={styles.form} onSubmit={handleSubmit} noValidate>
                    ...
                    <div className={styles.field}>
                      <label className={styles.label} htmlFor="v2r-message">Describe the job</label>
                      <textarea id="v2r-message" className={`${styles.input} ${styles.textarea}`}
                        name="message" placeholder="What needs cleaning? Any details help." rows={3}
