...
const LocalCitationBlock: React.FC<LocalCitationBlockProps> = ({
  businessName  = 'AquaBlast Pressure Washing',
  address       = '1187 Lake Shore Dr, Waco, TX 76708',
  phone         = '(254) 900-8842',
  email         = 'contact@aquablastpw.com',
  googleMapsUrl = 'https://maps.google.com/?q=AquaBlast+Pressure+Washing+Waco+TX',
  hours         = DEFAULT_HOURS,
  cityName      = 'Waco',
}) => {
  return (
      ...
      <div className={styles.container}>
        ...
        <div className={styles.header}>
          ...
          <p className={styles.subtitle}>
            Based in {cityName}, TX — serving all of Central Texas with licensed, bonded exterior cleaning crews.
          </p>
        </div>
