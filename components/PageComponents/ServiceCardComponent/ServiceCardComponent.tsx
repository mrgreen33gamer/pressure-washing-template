...
export default function ServiceCardComponent({
  cards,
  heading    = 'Everything Your Exterior Needs',
  subheading = 'From soft-wash house washing to commercial concrete cleaning, AquaBlast handles it all — on time, on price.',
