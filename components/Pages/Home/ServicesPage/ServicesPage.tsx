  ...
  return (
    ...
    >
      ...
      <nav aria-label="Services navigation" style={{
        ...
        <Link href="/services">All Services — AquaBlast Pressure Washing</Link>
      </nav>

      <span id={styles.backgroundImage}>
        <Image quality={100} fill style={{ objectFit: 'cover' }} sizes="100vw" src='/pages/home/services/background-image.png?v=3' alt="Background Image for Services Page - AquaBlast Pressure Washing - Background" />
      </span>
    ...
    >
      ...
      >
        <Image
          ...
          src={imgSrc}
          quality={100}
          alt={`${imgAlt} - AquaBlast Pressure Washing LLC - Waco TX`}
        />
      </motion.div>
    </motion.div>
  );
