...
const slug     = 'soft-washing-vs-pressure-washing-whats-the-difference';
...
export const metadata: Metadata = {
  ...
  keywords: ['soft wash vs pressure wash', 'soft washing texas', 'pressure washing vs soft wash', 'roof soft wash'],
...
const articleSchema = {
  ...
  keywords: 'soft wash vs pressure wash, soft washing texas',
