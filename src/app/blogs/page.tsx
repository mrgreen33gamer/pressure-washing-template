    ...
    <main className={styles.page}>
      ...
      <section className={styles.pageHeader}>
        ...
        >
          ...
          <h1 className={styles.pageTitle}>AquaBlast Pressure Washing — Blog Center</h1>
          <p className={styles.pageSubtitle}>
            Real talk and useful tips for Central Texas homeowners — soft washing, driveway care, roof algae, and exterior maintenance.
          </p>
        </motion.div>
      </section>
        ...
        <div className={styles.container}>
          ...
          >
            <p className={styles.blogCTAHeading}>
              Need professional pressure washing in Central Texas?
            </p>
            <p className={styles.blogCTABody}>
              We've been keeping Waco-area homes and businesses spotless with expert exterior cleaning since 2015. Free estimate, no obligations.
            </p>
