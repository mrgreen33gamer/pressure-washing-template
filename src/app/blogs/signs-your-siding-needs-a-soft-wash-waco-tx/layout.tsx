...
const slug     = 'signs-your-siding-needs-a-soft-wash-waco-tx';
...
export const metadata: Metadata = {
  ...
  keywords: ['soft wash waco tx', 'siding cleaning waco', 'house washing waco tx', 'mildew on siding central texas'],
...
const articleSchema = {
  ...
  keywords: 'soft wash waco tx, siding cleaning, house washing waco',
  articleSection: 'House Washing',
  inLanguage: 'en-US',
};
