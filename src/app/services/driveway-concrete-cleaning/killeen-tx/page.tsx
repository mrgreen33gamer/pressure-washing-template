// AquaBlast — Driveway & Concrete Cleaning in Killeen, TX
"use client";
...
export default function KilleenDrivewayConcreteCleaningPage() {

  const whyFeatures = [
    { icon: faClock, title: "Local Killeen Crews", description: "AquaBlast provides driveway & concrete cleaning with serving Killeen and Fort Cavazos area properties. Flat-rate pricing and free re-clean guarantee on every job." },
    { icon: faRoad, title: "Driveway & Concrete Cleaning Specialists", description: "High-pressure cleaning for driveways, sidewalks, patios, and parking pads. Oil stains, tire marks, mildew, and years of buildup — gone." },
  ...
  const metrics = [
    { icon: faTrophy, value: 2000, label: "Driveways and hardscapes cleaned", suffix: "+", duration: 2 },
  ...
  const faq = [
    { question: "Do you offer driveway & concrete cleaning in Killeen?", answer: "Yes — AquaBlast regularly serves Killeen and Bell County with the same flat-rate pricing and free re-clean guarantee as our Waco jobs." },
  ...
  return (
    <main className={styles.pageWrapper}>
      <Breadcrumb crumbs={[
        ...
        { label: "Driveway & Concrete Cleaning", href: "/services/driveway-concrete-cleaning" },
        { label: "Killeen, TX" },
      ]} />

      <SectionIntro
        title="Driveway & Concrete Cleaning in Killeen, TX"
        subtitle="High-pressure cleaning for driveways, sidewalks, patios, and parking pads. Oil stains, tire marks, mildew, and years of buildup — gone. Serving Killeen and Bell County with flat-rate pricing and a free re-clean guarantee."
      />

      <TrustBar headline="Trusted driveway & concrete cleaning for Killeen homes and businesses" />
      ...
      <div className={styles.section}>
        <WhatToExpect sectionTitle={`Driveway & Concrete Cleaning in Killeen — What to Expect`} expectations={expectations} />
      </div>
      ...
      <div className={styles.section}>
        <FAQ cityName="Killeen" faq={faq} title={`Driveway & Concrete Cleaning in Killeen — FAQs`} />
      </div>

      <CTABanner
        headline={`Driveway & Concrete Cleaning in Killeen — Book Today`}
      ...
      <div className={styles.section}>
        <Variant4
          title={`Schedule Concrete Cleaning — Killeen`}
          cityName="Killeen"
          slug={`services/driveway-concrete-cleaning/killeen-tx`}
          spot={`driveway-concrete-cleaning-killeen-tx-form`}
          formVariant={2}
        />
      </div>
    </main>
