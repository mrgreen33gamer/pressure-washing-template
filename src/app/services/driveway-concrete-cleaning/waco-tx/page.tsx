// AquaBlast — Driveway & Concrete Cleaning in Waco, TX
"use client";
...
export default function WacoDrivewayConcreteCleaningPage() {

  const whyFeatures = [
    { icon: faClock, title: "Local Waco Crews", description: "AquaBlast provides driveway & concrete cleaning with home base with the fastest scheduling in the city. Flat-rate pricing and free re-clean guarantee on every job." },
  ...
  const faq = [
    { question: "Do you offer driveway & concrete cleaning in Waco?", answer: "Yes — AquaBlast regularly serves Waco and McLennan County with the same flat-rate pricing and free re-clean guarantee as our Waco jobs." },
  ...
  return (
    <main className={styles.pageWrapper}>
      ...
      <SectionIntro
        ...
        subtitle="High-pressure cleaning for driveways, sidewalks, patios, and parking pads. Oil stains, tire marks, mildew, and years of buildup — gone. Serving Waco and McLennan County with flat-rate pricing and a free re-clean guarantee."
      />

      <TrustBar headline="Trusted driveway & concrete cleaning for Waco homes and businesses" />
      ...
      <div className={styles.section}>
        <WhatToExpect sectionTitle={`Driveway & Concrete Cleaning in Waco — What to Expect`} expectations={expectations} />
      </div>
      ...
      <div className={styles.section}>
        <FAQ cityName="Waco" faq={faq} title={`Driveway & Concrete Cleaning in Waco — FAQs`} />
      </div>

      <CTABanner
        headline={`Driveway & Concrete Cleaning in Waco — Book Today`}
      ...
      <div className={styles.section}>
        <Variant4
          title={`Schedule Concrete Cleaning — Waco`}
          cityName="Waco"
          slug={`services/driveway-concrete-cleaning/waco-tx`}
          spot={`driveway-concrete-cleaning-waco-tx-form`}
          formVariant={2}
        />
      </div>
    </main>
