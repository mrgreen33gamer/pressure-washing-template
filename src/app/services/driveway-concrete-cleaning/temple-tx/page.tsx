// AquaBlast — Driveway & Concrete Cleaning in Temple, TX
"use client";
...
export default function TempleDrivewayConcreteCleaningPage() {

  const whyFeatures = [
    { icon: faClock, title: "Local Temple Crews", description: "AquaBlast provides driveway & concrete cleaning with full residential and commercial coverage across Temple. Flat-rate pricing and free re-clean guarantee on every job." },
  ...
  const faq = [
    { question: "Do you offer driveway & concrete cleaning in Temple?", answer: "Yes — AquaBlast regularly serves Temple and Bell County with the same flat-rate pricing and free re-clean guarantee as our Waco jobs." },
  ...
  return (
    <main className={styles.pageWrapper}>
      ...
      <SectionIntro
        title="Driveway & Concrete Cleaning in Temple, TX"
        subtitle="High-pressure cleaning for driveways, sidewalks, patios, and parking pads. Oil stains, tire marks, mildew, and years of buildup — gone. Serving Temple and Bell County with flat-rate pricing and a free re-clean guarantee."
      />

      <TrustBar headline="Trusted driveway & concrete cleaning for Temple homes and businesses" />
      ...
      <div className={styles.section}>
        <WhatToExpect sectionTitle={`Driveway & Concrete Cleaning in Temple — What to Expect`} expectations={expectations} />
      </div>
      ...
      <div className={styles.section}>
        <FAQ cityName="Temple" faq={faq} title={`Driveway & Concrete Cleaning in Temple — FAQs`} />
      </div>

      <CTABanner
        headline={`Driveway & Concrete Cleaning in Temple — Book Today`}
      ...
      <div className={styles.section}>
        <Variant4
          title={`Schedule Concrete Cleaning — Temple`}
          cityName="Temple"
          slug={`services/driveway-concrete-cleaning/temple-tx`}
          spot={`driveway-concrete-cleaning-temple-tx-form`}
          formVariant={2}
        />
      </div>
    </main>
