// AquaBlast — House Washing in Temple, TX
"use client";
...
export default function TempleHouseWashingPage() {

  const whyFeatures = [
    { icon: faClock, title: "Local Temple Crews", description: "AquaBlast provides house washing with full residential and commercial coverage across Temple. Flat-rate pricing and free re-clean guarantee on every job." },
  ...
  const faq = [
    { question: "Do you offer house washing in Temple?", answer: "Yes — AquaBlast regularly serves Temple and Bell County with the same flat-rate pricing and free re-clean guarantee as our Waco jobs." },
  ...
  return (
    <main className={styles.pageWrapper}>
      ...
      <SectionIntro
        title="House Washing in Temple, TX"
        subtitle="Low-pressure soft wash that lifts mold, mildew, pollen, and dirt without damaging siding, paint, or landscaping. Serving Temple and Bell County with flat-rate pricing and a free re-clean guarantee."
      />

      <TrustBar headline="Trusted house washing for Temple homes and businesses" />
      ...
      <div className={styles.section}>
        <WhatToExpect sectionTitle={`House Washing in Temple — What to Expect`} expectations={expectations} />
      </div>
      ...
      <div className={styles.section}>
        <FAQ cityName="Temple" faq={faq} title={`House Washing in Temple — FAQs`} />
      </div>

      <CTABanner
        headline={`House Washing in Temple — Book Today`}
      ...
      <div className={styles.section}>
        <Variant4
          title={`Schedule Your House Wash — Temple`}
          cityName="Temple"
          slug={`services/house-washing/temple-tx`}
          spot={`house-washing-temple-tx-form`}
          formVariant={2}
        />
      </div>
    </main>
