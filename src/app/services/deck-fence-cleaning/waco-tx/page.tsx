// AquaBlast — Deck & Fence Cleaning in Waco, TX
"use client";
...
export default function WacoDeckFenceCleaningPage() {

  const whyFeatures = [
    { icon: faClock, title: "Local Waco Crews", description: "AquaBlast provides deck & fence cleaning with home base with the fastest scheduling in the city. Flat-rate pricing and free re-clean guarantee on every job." },
  ...
  const faq = [
    { question: "Do you offer deck & fence cleaning in Waco?", answer: "Yes — AquaBlast regularly serves Waco and McLennan County with the same flat-rate pricing and free re-clean guarantee as our Waco jobs." },
  ...
  return (
    <main className={styles.pageWrapper}>
      ...
      <SectionIntro
        ...
        subtitle="Restore weathered wood, composite, and vinyl fences and decks with surface-safe cleaning that prepares for sealing or staining. Serving Waco and McLennan County with flat-rate pricing and a free re-clean guarantee."
      />

      <TrustBar headline="Trusted deck & fence cleaning for Waco homes and businesses" />
      ...
      <div className={styles.section}>
        <WhatToExpect sectionTitle={`Deck & Fence Cleaning in Waco — What to Expect`} expectations={expectations} />
      </div>
      ...
      <div className={styles.section}>
        <FAQ cityName="Waco" faq={faq} title={`Deck & Fence Cleaning in Waco — FAQs`} />
      </div>

      <CTABanner
        headline={`Deck & Fence Cleaning in Waco — Book Today`}
      ...
      <div className={styles.section}>
        <Variant4
          title={`Schedule Deck & Fence Cleaning — Waco`}
          cityName="Waco"
          slug={`services/deck-fence-cleaning/waco-tx`}
          spot={`deck-fence-cleaning-waco-tx-form`}
          formVariant={2}
        />
      </div>
    </main>
