// AquaBlast — Deck & Fence Cleaning in Temple, TX
"use client";
...
export default function TempleDeckFenceCleaningPage() {

  const whyFeatures = [
    { icon: faClock, title: "Local Temple Crews", description: "AquaBlast provides deck & fence cleaning with full residential and commercial coverage across Temple. Flat-rate pricing and free re-clean guarantee on every job." },
  ...
  const faq = [
    { question: "Do you offer deck & fence cleaning in Temple?", answer: "Yes — AquaBlast regularly serves Temple and Bell County with the same flat-rate pricing and free re-clean guarantee as our Waco jobs." },
  ...
  return (
    <main className={styles.pageWrapper}>
      ...
      <SectionIntro
        title="Deck & Fence Cleaning in Temple, TX"
        subtitle="Restore weathered wood, composite, and vinyl fences and decks with surface-safe cleaning that prepares for sealing or staining. Serving Temple and Bell County with flat-rate pricing and a free re-clean guarantee."
      />

      <TrustBar headline="Trusted deck & fence cleaning for Temple homes and businesses" />
      ...
      <div className={styles.section}>
        <WhatToExpect sectionTitle={`Deck & Fence Cleaning in Temple — What to Expect`} expectations={expectations} />
      </div>
      ...
      <div className={styles.section}>
        <FAQ cityName="Temple" faq={faq} title={`Deck & Fence Cleaning in Temple — FAQs`} />
      </div>

      <CTABanner
        headline={`Deck & Fence Cleaning in Temple — Book Today`}
      ...
      <div className={styles.section}>
        <Variant4
          title={`Schedule Deck & Fence Cleaning — Temple`}
          cityName="Temple"
          slug={`services/deck-fence-cleaning/temple-tx`}
          spot={`deck-fence-cleaning-temple-tx-form`}
          formVariant={2}
        />
      </div>
    </main>
