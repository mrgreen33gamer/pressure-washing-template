// AquaBlast — Deck & Fence Cleaning in Killeen, TX
"use client";
...
export default function KilleenDeckFenceCleaningPage() {

  const whyFeatures = [
    { icon: faClock, title: "Local Killeen Crews", description: "AquaBlast provides deck & fence cleaning with serving Killeen and Fort Cavazos area properties. Flat-rate pricing and free re-clean guarantee on every job." },
    { icon: faTree, title: "Deck & Fence Cleaning Specialists", description: "Restore weathered wood, composite, and vinyl fences and decks with surface-safe cleaning that prepares for sealing or staining." },
  ...
  const metrics = [
    { icon: faTrophy, value: 1100, label: "Decks and fences restored", suffix: "+", duration: 2 },
  ...
  const faq = [
    { question: "Do you offer deck & fence cleaning in Killeen?", answer: "Yes — AquaBlast regularly serves Killeen and Bell County with the same flat-rate pricing and free re-clean guarantee as our Waco jobs." },
  ...
  return (
    <main className={styles.pageWrapper}>
      ...
      <SectionIntro
        title="Deck & Fence Cleaning in Killeen, TX"
        subtitle="Restore weathered wood, composite, and vinyl fences and decks with surface-safe cleaning that prepares for sealing or staining. Serving Killeen and Bell County with flat-rate pricing and a free re-clean guarantee."
      />

      <TrustBar headline="Trusted deck & fence cleaning for Killeen homes and businesses" />
      ...
      <div className={styles.section}>
        <WhatToExpect sectionTitle={`Deck & Fence Cleaning in Killeen — What to Expect`} expectations={expectations} />
      </div>
      ...
      <div className={styles.section}>
        <FAQ cityName="Killeen" faq={faq} title={`Deck & Fence Cleaning in Killeen — FAQs`} />
      </div>

      <CTABanner
        headline={`Deck & Fence Cleaning in Killeen — Book Today`}
      ...
      <div className={styles.section}>
        <Variant4
          title={`Schedule Deck & Fence Cleaning — Killeen`}
          cityName="Killeen"
          slug={`services/deck-fence-cleaning/killeen-tx`}
          spot={`deck-fence-cleaning-killeen-tx-form`}
          formVariant={2}
        />
      </div>
    </main>
