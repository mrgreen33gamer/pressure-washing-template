// AquaBlast — Gutter Cleaning in Killeen, TX
"use client";
...
export default function KilleenGutterCleaningPage() {

  const whyFeatures = [
    { icon: faClock, title: "Local Killeen Crews", description: "AquaBlast provides gutter cleaning with serving Killeen and Fort Cavazos area properties. Flat-rate pricing and free re-clean guarantee on every job." },
    { icon: faDroplet, title: "Gutter Cleaning Specialists", description: "Full gutter and downspout clearing so water flows free — preventing overflow damage, foundation issues, and mosquito breeding grounds." },
  ...
  const metrics = [
    { icon: faTrophy, value: 1800, label: "Gutter systems cleaned", suffix: "+", duration: 2 },
  ...
  const faq = [
    { question: "Do you offer gutter cleaning in Killeen?", answer: "Yes — AquaBlast regularly serves Killeen and Bell County with the same flat-rate pricing and free re-clean guarantee as our Waco jobs." },
  ...
  return (
    <main className={styles.pageWrapper}>
      ...
      <SectionIntro
        title="Gutter Cleaning in Killeen, TX"
        subtitle="Full gutter and downspout clearing so water flows free — preventing overflow damage, foundation issues, and mosquito breeding grounds. Serving Killeen and Bell County with flat-rate pricing and a free re-clean guarantee."
      />

      <TrustBar headline="Trusted gutter cleaning for Killeen homes and businesses" />
      ...
      <div className={styles.section}>
        <WhatToExpect sectionTitle={`Gutter Cleaning in Killeen — What to Expect`} expectations={expectations} />
      </div>
      ...
      <div className={styles.section}>
        <FAQ cityName="Killeen" faq={faq} title={`Gutter Cleaning in Killeen — FAQs`} />
      </div>

      <CTABanner
        headline={`Gutter Cleaning in Killeen — Book Today`}
      ...
      <div className={styles.section}>
        <Variant4
          title={`Schedule Gutter Cleaning — Killeen`}
          cityName="Killeen"
          slug={`services/gutter-cleaning/killeen-tx`}
          spot={`gutter-cleaning-killeen-tx-form`}
          formVariant={2}
        />
      </div>
    </main>
