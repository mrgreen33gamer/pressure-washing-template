// AquaBlast — Gutter Cleaning in Temple, TX
"use client";
...
export default function TempleGutterCleaningPage() {

  const whyFeatures = [
    { icon: faClock, title: "Local Temple Crews", description: "AquaBlast provides gutter cleaning with full residential and commercial coverage across Temple. Flat-rate pricing and free re-clean guarantee on every job." },
  ...
  const faq = [
    { question: "Do you offer gutter cleaning in Temple?", answer: "Yes — AquaBlast regularly serves Temple and Bell County with the same flat-rate pricing and free re-clean guarantee as our Waco jobs." },
  ...
  return (
    <main className={styles.pageWrapper}>
      ...
      <SectionIntro
        title="Gutter Cleaning in Temple, TX"
        subtitle="Full gutter and downspout clearing so water flows free — preventing overflow damage, foundation issues, and mosquito breeding grounds. Serving Temple and Bell County with flat-rate pricing and a free re-clean guarantee."
      />

      <TrustBar headline="Trusted gutter cleaning for Temple homes and businesses" />
      ...
      <div className={styles.section}>
        <WhatToExpect sectionTitle={`Gutter Cleaning in Temple — What to Expect`} expectations={expectations} />
      </div>
      ...
      <div className={styles.section}>
        <FAQ cityName="Temple" faq={faq} title={`Gutter Cleaning in Temple — FAQs`} />
      </div>

      <CTABanner
        headline={`Gutter Cleaning in Temple — Book Today`}
      ...
      <div className={styles.section}>
        <Variant4
          title={`Schedule Gutter Cleaning — Temple`}
          cityName="Temple"
          slug={`services/gutter-cleaning/temple-tx`}
          spot={`gutter-cleaning-temple-tx-form`}
          formVariant={2}
        />
      </div>
    </main>
