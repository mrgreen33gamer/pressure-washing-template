// AquaBlast — Gutter Cleaning in Waco, TX
"use client";
...
export default function WacoGutterCleaningPage() {

  const whyFeatures = [
    { icon: faClock, title: "Local Waco Crews", description: "AquaBlast provides gutter cleaning with home base with the fastest scheduling in the city. Flat-rate pricing and free re-clean guarantee on every job." },
  ...
  const faq = [
    { question: "Do you offer gutter cleaning in Waco?", answer: "Yes — AquaBlast regularly serves Waco and McLennan County with the same flat-rate pricing and free re-clean guarantee as our Waco jobs." },
  ...
  return (
    <main className={styles.pageWrapper}>
      ...
      <SectionIntro
        ...
        subtitle="Full gutter and downspout clearing so water flows free — preventing overflow damage, foundation issues, and mosquito breeding grounds. Serving Waco and McLennan County with flat-rate pricing and a free re-clean guarantee."
      />

      <TrustBar headline="Trusted gutter cleaning for Waco homes and businesses" />
      ...
      <div className={styles.section}>
        <WhatToExpect sectionTitle={`Gutter Cleaning in Waco — What to Expect`} expectations={expectations} />
      </div>
      ...
      <div className={styles.section}>
        <FAQ cityName="Waco" faq={faq} title={`Gutter Cleaning in Waco — FAQs`} />
      </div>

      <CTABanner
        headline={`Gutter Cleaning in Waco — Book Today`}
      ...
      <div className={styles.section}>
        <Variant4
          title={`Schedule Gutter Cleaning — Waco`}
          cityName="Waco"
          slug={`services/gutter-cleaning/waco-tx`}
          spot={`gutter-cleaning-waco-tx-form`}
          formVariant={2}
        />
      </div>
    </main>
