// AquaBlast — Roof Cleaning in Temple, TX
"use client";
...
export default function TempleRoofCleaningPage() {

  const whyFeatures = [
    { icon: faClock, title: "Local Temple Crews", description: "AquaBlast provides roof cleaning with full residential and commercial coverage across Temple. Flat-rate pricing and free re-clean guarantee on every job." },
  ...
  const faq = [
    { question: "Do you offer roof cleaning in Temple?", answer: "Yes — AquaBlast regularly serves Temple and Bell County with the same flat-rate pricing and free re-clean guarantee as our Waco jobs." },
  ...
  return (
    <main className={styles.pageWrapper}>
      ...
      <SectionIntro
        title="Roof Cleaning in Temple, TX"
        subtitle="Soft-wash roof cleaning that kills black algae streaks and moss at the root — safe for asphalt shingles, tile, and metal roofs. Serving Temple and Bell County with flat-rate pricing and a free re-clean guarantee."
      />

      <TrustBar headline="Trusted roof cleaning for Temple homes and businesses" />
      ...
      <div className={styles.section}>
        <WhatToExpect sectionTitle={`Roof Cleaning in Temple — What to Expect`} expectations={expectations} />
      </div>
      ...
      <div className={styles.section}>
        <FAQ cityName="Temple" faq={faq} title={`Roof Cleaning in Temple — FAQs`} />
      </div>

      <CTABanner
        headline={`Roof Cleaning in Temple — Book Today`}
      ...
      <div className={styles.section}>
        <Variant4
          title={`Schedule Roof Cleaning — Temple`}
          cityName="Temple"
          slug={`services/roof-cleaning/temple-tx`}
          spot={`roof-cleaning-temple-tx-form`}
          formVariant={2}
        />
      </div>
    </main>
