// AquaBlast — Roof Cleaning in Killeen, TX
"use client";
...
export default function KilleenRoofCleaningPage() {

  const whyFeatures = [
    { icon: faClock, title: "Local Killeen Crews", description: "AquaBlast provides roof cleaning with serving Killeen and Fort Cavazos area properties. Flat-rate pricing and free re-clean guarantee on every job." },
  ...
  const faq = [
    { question: "Do you offer roof cleaning in Killeen?", answer: "Yes — AquaBlast regularly serves Killeen and Bell County with the same flat-rate pricing and free re-clean guarantee as our Waco jobs." },
  ...
  return (
    <main className={styles.pageWrapper}>
      ...
      <SectionIntro
        title="Roof Cleaning in Killeen, TX"
        subtitle="Soft-wash roof cleaning that kills black algae streaks and moss at the root — safe for asphalt shingles, tile, and metal roofs. Serving Killeen and Bell County with flat-rate pricing and a free re-clean guarantee."
      />

      <TrustBar headline="Trusted roof cleaning for Killeen homes and businesses" />
      ...
      <div className={styles.section}>
        <WhatToExpect sectionTitle={`Roof Cleaning in Killeen — What to Expect`} expectations={expectations} />
      </div>
      ...
      <div className={styles.section}>
        <FAQ cityName="Killeen" faq={faq} title={`Roof Cleaning in Killeen — FAQs`} />
      </div>

      <CTABanner
        headline={`Roof Cleaning in Killeen — Book Today`}
      ...
      <div className={styles.section}>
        <Variant4
          title={`Schedule Roof Cleaning — Killeen`}
          cityName="Killeen"
          slug={`services/roof-cleaning/killeen-tx`}
          spot={`roof-cleaning-killeen-tx-form`}
          formVariant={2}
        />
      </div>
    </main>
