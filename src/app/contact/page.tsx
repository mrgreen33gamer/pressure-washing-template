...
// AquaBlast Pressure Washing — Contact Page (unique build, not just a form import)
...
// ── Service options ────────────────────────────────────────────────────────────
const SERVICES = [
  'House Washing', 'Roof Cleaning', 'Driveway & Concrete',
...
const faq = [
  {
    ...
    answer: "Call us directly at (254) 900-8842 or fill out the form below. We respond to most requests within one business day and can usually schedule an on-site estimate within the week.",
  },
  {
  ...
  },
  {
    ...
    answer: "No — on-site estimates are always free, with no obligation to book. We'll walk the property with you and leave you with a firm written price.",
  },
  {
    question: 'Do you handle commercial pressure washing?',
    answer: 'Yes — storefronts, parking lots, restaurants, HOAs, and multi-unit properties are all within our scope. Call to discuss your project and schedule.',
  },
  {
    question: 'What areas do you serve?',
    answer: 'Waco, Hewitt, Woodway, Robinson, China Spring, Temple, Killeen, and most of Central Texas within about 60 miles of Waco. Call us — we probably cover your area.',
  },
  {
    question: 'How do I know if I need soft washing or pressure washing?',
    answer: "Our crew will tell you honestly after the on-site assessment. Soft wash for siding and roofs; high pressure for concrete and durable hardscape. We'll explain the approach before we start.",
  },
];
  ...
  return (
    <main className={styles.page}>
      ...
      <section className={styles.hero}>
        ...
        <div className={styles.heroInner}>
          ...
          <motion.h1 className={styles.heroTitle}
            ...
            Let&apos;s Get Your<br />
            <span className={styles.heroAccent}>Exterior Spotless</span>
          </motion.h1>
        ...
        <div className={styles.mainInner}>
          ...
          <div className={styles.leftCol}>
            ...
            <div className={styles.infoCards}>
              {[
                ...
                },
                {
                  ...
                  label:     'Email',
                  value:     'contact@aquablastpw.com',
                  href:      'mailto:contact@aquablastpw.com',
                ...
                },
                {
                  ...
                  label:     'Address',
                  value:     '1187 Lake Shore Dr, Waco TX 76708',
                  href:      'https://maps.google.com/?q=1187+Lake+Shore+Dr+Waco+TX+76708',
                ...
                },
                {
                  ...
                  label:     'Hours',
                  value:     'Mon–Fri 7am–7pm · Sat 8am–5pm · Sun by appointment',
                  href:      null,
                  eventType: null,
                  eventLabel: null,
                },
            ...
            <div className={styles.trustBlock}>
              <p className={styles.trustHeading}>Why homeowners choose AquaBlast</p>
              {[
                'Flat-rate pricing — written quote before we start',
                'Free re-clean if you\'re not happy',
                'Licensed, bonded & insured crews only',
              ...
              {submitted ? (
                <motion.div key="success" className={styles.successCard}
                  ...
                  <p className={styles.successText}>
                    An AquaBlast crew lead will reach out shortly — usually within one business day. For urgent needs, call us at{' '}
                    <a href="tel:+12549008842">(254) 900-8842</a>.
                  </p>
                ...
                <motion.div key="form" className={styles.formCard}
                  ...
                  <form className={styles.form} onSubmit={handleSubmit} noValidate>
                    ...
                    <button type="submit" disabled={isSubmitting} className={styles.submitBtn}>
                      {isSubmitting
                        ? <PulseLoader size={8} color="#06232b" />
                        : (
                          <>
      ...
      <CTABanner
        ...
        subline="Call (254) 900-8842 — we answer 7 days a week. Same-day service available across Central Texas."
        primaryText="Call (254) 900-8842"
        primaryLink="tel:+12549008842"
        secondaryText="Send a Text"
        secondaryLink="sms:+12549008842"
      />
